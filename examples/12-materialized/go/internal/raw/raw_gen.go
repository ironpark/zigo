...
#cgo LDFLAGS: ${SRCDIR}/../../../zig-out/lib/libmaterialized_zigo.a
#include "zigo_materialized.h"
*/
import "C"
import "unsafe"
...
// ProbeMany calls the generated C ABI wrapper for zg_probe_many.
func ProbeMany() ([]byte, int32) {
	var outResultPtr *C.uint8_t
	var outResultLen C.size_t
	code := int32(C.zg_probe_many(&outResultPtr, &outResultLen))
	if code != 0 {
		return nil, code
	}
	var result []uint8
