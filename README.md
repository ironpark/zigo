...
```bash
zig fetch --save git+https://github.com/ironpark/zigo#0.19.2
```
...
여러 OS·아키텍처를 한 Go 트리에서 지원하려면 cgo·purego 모두 `targets`를 나열하세요
([여러 타깃용 cgo 라이브러리](docs/configuration.md#여러-타깃용-네이티브-라이브러리)).
