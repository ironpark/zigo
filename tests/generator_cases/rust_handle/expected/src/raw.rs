...
extern "C" {
    ...
    pub fn zg_context_set_total(self_: *mut zg_context, c: i64) -> i32;
    ...
    pub fn zg_sum_copies(bias: i64, left: *const zg_context, right: *const zg_context, out_result: *mut i64) -> i32;
...
/// Calls the generated C ABI wrapper for `zg_context_set_total`.
///
/// # Safety
///
/// Every handle argument must point at a live native object of its own
/// type. The generated wrapper that owns the handle guarantees this; a
/// hand-written caller has to.
pub unsafe fn context_set_total(receiver: *mut zg_context, c: i64) -> i32 {
    unsafe { zg_context_set_total(receiver, c) }
}
...
/// Calls the generated C ABI wrapper for `zg_sum_copies`.
///
/// # Safety
///
/// Every handle argument must point at a live native object of its own
/// type. The generated wrapper that owns the handle guarantees this; a
/// hand-written caller has to.
pub unsafe fn sum_copies(bias: i64, left: *const zg_context, right: *const zg_context) -> (i64, i32) {
    let mut out_result: i64 = 0;
    let code = unsafe { zg_sum_copies(bias, left, right, &mut out_result) };
    (out_result, code)
}
