...
int32_t zg_hub_create_purego_v2_impl(int32_t (*observer)(int32_t, size_t), size_t userdata, zg_hub * * out_result);
ZIGO_EXPORT int32_t zg_hub_create_purego_v2(int32_t (*observer)(int32_t, size_t), size_t userdata, zg_hub * * out_result) {
    ...
    int32_t result = zg_hub_create_purego_v2_impl(observer, userdata, out_result);
    zg_panic_active = 0;
    return result;
}
...
int32_t zg_hub_set_observer_purego_v2_impl(zg_hub * self, int32_t (*observer)(int32_t, size_t), size_t userdata);
ZIGO_EXPORT int32_t zg_hub_set_observer_purego_v2(zg_hub * self, int32_t (*observer)(int32_t, size_t), size_t userdata) {
    ...
    int32_t result = zg_hub_set_observer_purego_v2_impl(self, observer, userdata);
    zg_panic_active = 0;
    return result;
}
...
int32_t zg_apply_purego_v2_impl(int32_t value, int32_t (*observer)(int32_t, size_t), size_t userdata);
ZIGO_EXPORT int32_t zg_apply_purego_v2(int32_t value, int32_t (*observer)(int32_t, size_t), size_t userdata) {
    ...
    int32_t result = zg_apply_purego_v2_impl(value, observer, userdata);
    zg_panic_active = 0;
    return result;
}
