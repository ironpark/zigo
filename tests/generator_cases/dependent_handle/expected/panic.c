...
int32_t zg_child_free_child_impl(zg_child * self);
ZIGO_EXPORT int32_t zg_child_free_child(zg_child * self) {
    ...
    int32_t result = zg_child_free_child_impl(self);
    zg_panic_active = 0;
    return result;
}

int32_t zg_child_touch_impl(zg_child * self);
ZIGO_EXPORT int32_t zg_child_touch(zg_child * self) {
    ...
    int32_t result = zg_child_touch_impl(self);
    zg_panic_active = 0;
    return result;
}
