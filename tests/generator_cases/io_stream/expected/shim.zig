...
export fn zg_document_dump_impl(self: *target.Document, w_userdata: usize) i32 {
...
export fn zg_document_load_impl(self: *target.Document, r_data: [*c]const u8, r_data_len: usize, r_userdata: usize, out_result: *usize) i32 {
...
export fn zg_banner_impl(out_userdata: usize, width: i32) void {
    ...
    var out_stream: ZigoWriterAdapter = .init(out_stream_buffer, &zg_zigo_stream_write, out_userdata);
