...
export fn zg_stream_dump_impl(self: *target.Stream, w_userdata: usize) i32 {
    var w_stream_buffer: [65536]u8 = undefined;
    var w_stream: ZigoWriterAdapter = .init(&w_stream_buffer, &zg_zigo_stream_write, w_userdata);
...
export fn zg_stream_load_impl(self: *target.Stream, r_data: [*c]const u8, r_data_len: usize, r_userdata: usize, out_result: *usize) i32 {
    var r_stream_buffer: [65536]u8 = undefined;
    var r_stream: ZigoReaderAdapter = .init(&r_stream_buffer, &zg_zigo_stream_read, r_userdata);
...
export fn zg_buffer_render_impl(self: *target.Buffer, w_userdata: usize, out_result: *u32) i32 {
    var w_stream_buffer: [65536]u8 = undefined;
    var w_stream: ZigoWriterAdapter = .init(&w_stream_buffer, &zg_zigo_stream_write, w_userdata);
    defer w_stream.interface.flush() catch {};
...
export fn zg_buffer_fill_impl(self: *target.Buffer, r_data: [*c]const u8, r_data_len: usize, r_userdata: usize) i32 {
    var r_stream_buffer: [65536]u8 = undefined;
    var r_stream: ZigoReaderAdapter = .init(&r_stream_buffer, &zg_zigo_stream_read, r_userdata);
    var r_stream_fixed: std.Io.Reader = if (r_data != null) .fixed(r_data[0..r_data_len]) else undefined;
    const r_stream_interface: *std.Io.Reader = if (r_data != null) &r_stream_fixed else &r_stream.interface;
