...
type nativeBindings struct {
	...
	fnApply func(uint8, int, uintptr, float64, uint8, uint8, uint8, uint8, uint8, int16, uint8, uint8, uint8, uint8, uint8) int64
...
func Apply(behavior_tag uint8, behavior_delta int, behavior_page uint, behavior_ratio float64, behavior_animated uint8, behavior_mode uint8, behavior_rgb_r uint8, behavior_rgb_g uint8, behavior_rgb_b uint8, behavior_region_x int16, behavior_region_enabled uint8, behavior_region_color_r uint8, behavior_region_color_g uint8, behavior_region_color_b uint8, behavior_region_mode uint8) int64 {
	result := bindings().fnApply(behavior_tag, behavior_delta, uintptr(behavior_page), behavior_ratio, behavior_animated, behavior_mode, behavior_rgb_r, behavior_rgb_g, behavior_rgb_b, behavior_region_x, behavior_region_enabled, behavior_region_color_r, behavior_region_color_g, behavior_region_color_b, behavior_region_mode)
	return int64(result)
}
