...
extern "C" {
    pub fn zg_echo(mode: i8) -> i8;
    pub fn zg_pick_level(value: i8) -> i8;
    pub fn zg_pick_signal(value: u8) -> u8;
    pub fn zg_pick_plain(value: u8) -> u8;
...
pub unsafe fn echo(mode: i8) -> i8 {
    unsafe { zg_echo(mode) }
}

/// Calls the generated C ABI wrapper for `zg_pick_level`.
///
/// # Safety
///
/// Enum integer arguments must be valid values of the declared Zig enum,
/// including its original tag width.
pub unsafe fn pick_level(value: i8) -> i8 {
    unsafe { zg_pick_level(value) }
}

/// Calls the generated C ABI wrapper for `zg_pick_signal`.
///
/// # Safety
///
/// Enum integer arguments must be valid values of the declared Zig enum,
/// including its original tag width.
pub unsafe fn pick_signal(value: u8) -> u8 {
    unsafe { zg_pick_signal(value) }
}

/// Calls the generated C ABI wrapper for `zg_pick_plain`.
///
/// # Safety
///
/// Enum integer arguments must be valid values of the declared Zig enum,
/// including its original tag width.
pub unsafe fn pick_plain(value: u8) -> u8 {
    unsafe { zg_pick_plain(value) }
}
