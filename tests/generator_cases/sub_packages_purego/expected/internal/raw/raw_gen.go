...
var DefaultLibraryName = map[string]string{"darwin": "libpackages_zigo.dylib", "linux": "libpackages_zigo.so", "windows": "packages_zigo.dll"}[runtime.GOOS]
...
type nativeBindings struct {
	...
	fnUseMode func(uint8)
	fnInspectPoint func(unsafe.Pointer, unsafe.Pointer)
	fnReset func()
}
...
var libraryEnvVars = []string{"ZIGO_PACKAGES_LIBRARY_PATH", "ZIGO_LIBRARY_PATH"}
...
func InspectPoint(point PointData) PointData {
	...
	bindings().fnInspectPoint(unsafe.Pointer(&point), unsafe.Pointer(&outResult))
	return outResult
}
