...
pub fn zigoMaterialize_root(builder: *ZigoMaterializedBuilder, value: target.Root) !u64 {
    ...
    if (value.limit) |zigo_item0| {
        builder.writeWord(record + 56, 1, 1);
    builder.writeWord(record + 56 + 4, 4, zigoMaterializedScalar(zigo_item0));
    }
    if (value.label) |zigo_item0| {
        builder.writeU64(record + 64, try builder.appendBytes(zigo_item0[0..]));
        builder.writeU64(record + 64 + 8, zigo_item0.len);
    }
