...
uint32_t zg_to_lower_impl(uint32_t cp);
ZIGO_EXPORT uint32_t zg_to_lower(uint32_t cp) {
    ...
    uint32_t result = zg_to_lower_impl(cp);
    zg_panic_active = 0;
    return result;
}
...
uint8_t zg_peek_impl(uint32_t * out_result);
ZIGO_EXPORT uint8_t zg_peek(uint32_t * out_result) {
    ...
    uint8_t result = zg_peek_impl(out_result);
    zg_panic_active = 0;
    return result;
}
...
uint32_t zg_visit_impl(const uint8_t * text_ptr, size_t text_len, size_t userdata);
ZIGO_EXPORT uint32_t zg_visit(const uint8_t * text_ptr, size_t text_len, size_t userdata) {
    ...
    uint32_t result = zg_visit_impl(text_ptr, text_len, userdata);
    zg_panic_active = 0;
    return result;
}
