...
fn publicTypePath(allocator: std.mem.Allocator, program: abi.Program, options: Options) ![]u8 {
    return publicConcernPathAlloc(allocator, program, options, "type");
}
...
fn renderPublicTypes(allocator: std.mem.Allocator, writer: *std.Io.Writer, program: abi.Program, options: Options) !void {
    try renderPublicFile(allocator, writer, program, options, renderPublicUnionsBody);
}

fn renderPublicUnionsBody(allocator: std.mem.Allocator, writer: *std.Io.Writer, program: abi.Program, options: Options) !void {
