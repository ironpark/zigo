...
const read_limit: std.Io.Limit = .limited(64 * 1024 * 1024);
...
pub fn compareFile(
    ...
    const expected = try generated.readFileAlloc(io, generated_path, allocator, read_limit);
    defer allocator.free(expected);
    const actual = source.readFileAlloc(io, source_path, allocator, read_limit) catch |err| switch (err) {
