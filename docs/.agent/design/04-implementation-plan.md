...
> 과거 기록: 아래 옵션·지원 범위·마일스톤은 초기 구현 당시의 내용입니다. 현재 실행할
> 작업 목록으로 사용하지 마세요. 현재 구조는 [아키텍처](01-architecture.md), 검증 절차는
> [프로젝트 개발](../../development.md)을 참고하세요.
...
전제: Zig 0.16.0. 생성된 Go 코드는 Go 1.24+ 를 요구하고
CI는 Go 1.26.x로 검증한다.
