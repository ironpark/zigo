...
- [x] [Phase 03: Symbol override](phases/03-symbol-override.md)
- [x] [Phase 04: Fallback name gating](phases/04-fallback-name-gating.md)
- [x] [Phase 05: Docs and changelog](phases/05-docs-changelog.md)
