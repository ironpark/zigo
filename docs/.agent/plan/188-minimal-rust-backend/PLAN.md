...
- [ ] [Phase 00: Split the exported-name rule into a type rule and a function rule](phases/00-split-exported-name-rule.md)
- [ ] [Phase 01: Give Rust a Target value and an IR namespace](phases/01-rust-target-value.md)
- [ ] [Phase 02: Name the neutral emitters and write the Rust emitter](phases/02-rust-emitter.md)
