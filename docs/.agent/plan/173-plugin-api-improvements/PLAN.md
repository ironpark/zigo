...
Run focused tests per phase and the full Zig suite, external-plugin Go compile checks and CLI diagnostic checks.
...
Implement shared plugin paths and signature writers.
