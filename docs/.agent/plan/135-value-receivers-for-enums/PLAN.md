...
- [ ] [Phase 00: Reflect enum receivers](phases/00-reflect-enum-receivers.md)
- [ ] [Phase 01: Reject what a value receiver cannot mean](phases/01-value-receiver-diagnostics.md)
