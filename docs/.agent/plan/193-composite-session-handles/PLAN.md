...
- [x] [Phase 02: Close 의미론](phases/02-session-close.md)
- [x] [Phase 03: 예제와 ABI 불변 확인](phases/03-example-and-abi.md)
- [x] [Phase 04: 문서와 CHANGELOG](phases/04-docs-and-changelog.md)
