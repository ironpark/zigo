...
Focused plugin tests, generated Go compilation and the full zig build test suite.

# Decisions That Constrain Ordering

One integrated correction phase.

# Next Implementation Target

Implement and verify the three corrections.
