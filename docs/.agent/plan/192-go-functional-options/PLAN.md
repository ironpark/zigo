...
- [ ] [Phase 00: 기본값을 IR과 reflection에 싣기](phases/00-flattened-field-defaults.md)
- [ ] [Phase 01: `zigo.param.options` authoring API](phases/01-options-authoring-api.md)
- [ ] [Phase 02: 옵션 계약 진단](phases/02-options-diagnostics.md)
- [ ] [Phase 03: 옵션 타입과 `With*` 이름](phases/03-options-naming.md)
- [ ] [Phase 04: 공개 Go 생성자 방출](phases/04-options-emission.md)
