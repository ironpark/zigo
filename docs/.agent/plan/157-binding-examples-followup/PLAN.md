...
Run representative generated-output and ABI checks; use focused probes only if needed to verify a suspected behavior.
...
Review the polished examples and record the remaining improvements.
