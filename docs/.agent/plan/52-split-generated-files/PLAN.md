...
- [ ] [Phase 00: Per-file writer plumbing and static split (enums, handles, runtime)](phases/00-static-split.md)
- [ ] [Phase 01: Per-union files](phases/01-per-union-files.md)
