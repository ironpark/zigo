...
- [x] [Phase 08: Docs, changelog and release](phases/08-docs-and-release.md)
- [x] [Phase 09: Tagged union in the error union position](phases/09-tagged-union-in-the-error-union-position.md)
