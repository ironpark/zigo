...
Document.func("append", .{})
    .use(zigo.features.implements, .{ .kinds = &.{.writer} }),
...
`.kinds`는 비어 있을 수 없습니다. 같은 kind를 두 번 나열하면 Go 메서드가 두 번
